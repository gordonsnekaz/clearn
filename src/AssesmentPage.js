  ...
  return (
    <div className='container'>
      <div className="bg-red-600 rounded-lg shadow-md w-full flex-1 px-8 pt-12 pb-16">
        <div className=''>
          <p className="font-medium text-2xl text-gray-300"> Assesment </p>
        ...
        <div className='Progres'>
          <span className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-teal-800 mr-2 mb-2"> 4 assesments completed</span>
          <span className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-teal-800 mr-2 mb-2"> 2 assesments pending</span>
          <span className="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-teal-800 mr-2 mb-2"> 113+ Students Enrolled </span>
        </div>
      </div>
      <div className='py-8'>
        <p className='font-semibold text-md'> 3 Assesments </p>
      </div>
